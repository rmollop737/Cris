...
public class clienteFTPBasico extends JFrame {
	...
	//declaramos scaner 
	String servidor = JOptionPane.showInputDialog("Indica la URL del Servidor: (localhost)");

    String user = JOptionPane.showInputDialog("Indica el nombre de usuario: (usuario)");
    String pasw = JOptionPane.showInputDialog("Indica la contraseña del usuario: (usuario)");
	boolean login;
